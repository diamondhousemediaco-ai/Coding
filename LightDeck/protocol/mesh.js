...
(function (root) {
  ...
  class Node {
    ...
    async _onNet(type, data) { if (type !== 0x00) return; try { const d = await netDecode(data, this.net); if (d.ok && this._log) this._log('← msg src 0x' + d.src.toString(16) + ' op ' + b2h(d.transportPDU.slice(0, 2))); } catch (_) {} }
